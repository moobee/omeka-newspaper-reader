...
require_once dirname(__FILE__) . '/../../themes/bmn/config.php';
...
SQL
    ...
    public function hookAdminHead($args)
    {
        ...
        if ($request->getModuleName() == 'solr-search' && $request->action === 'reindex') {
            queue_css_file('solr-import');
            queue_js_file('solr-import');
            queue_js_file('spin');
        }
    }
